...
import { ArrowLeft, Search, X, FileText, Layers, Home, Scale, Heart, Gavel } from 'lucide-react';
        ...
        {!isReadPage && (
          <div className="flex justify-center mt-2">
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <NavLink to="/reading" icon={Scale} label="Lendo" isActive={isActive('/reading')} />
